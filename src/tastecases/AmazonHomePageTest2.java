...
public class AmazonHomePageTest2 {
...
@Test
public static void checkSearchbox() throws InterruptedException {
    ...
    @Test
    public static void walmart() throws InterruptedException {
        setUp("https://www.walmart.com/");
        Thread.sleep(1000);
        driverClose();
    }
}