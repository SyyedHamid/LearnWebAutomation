...
public class AmazonHomePageTest {
    ...
    public static void getStart() throws InterruptedException {
        ...
        String homePageVerify="//*[@id=\"nav-xshop\"]/a[5]";//for the verify we get xpath of a element
        ...
        Thread.sleep(10000);//use to keep wait the browser so i can input the code
